...
static __inline void wr_dat_stop(void) { LCD_CS(1); }
...
void GLCD_SetTextColor(unsigned short color) { Color[TXT_COLOR] = color; }
...
void GLCD_SetBackColor(unsigned short color) { Color[BG_COLOR] = color; }
 ...
 *   Return:                                                                    *
 *******************************************************************************/
void GLCD_WrCmd(unsigned char cmd) { wr_cmd(cmd); }
 ...
 *   Return:                                                                    *
 *******************************************************************************/
void GLCD_WrReg(unsigned char reg, unsigned short val) { wr_reg(reg, val); }
/******************************************************************************/
